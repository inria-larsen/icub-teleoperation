...
#define DEFAULT_YARP_CONTEXT "comRetargeting"
...
int main (int argc, char * argv[])
{
    ...
    ResourceFinder rf;
    rf.setVerbose(true);
    rf.setDefaultConfigFile("comRetargeting.ini");         //default config file name.
    ...
    if (rf.check("help"))
    {
        ...
        yInfo()<< "\t--name             :Prefix of the ports opened by the module. Set to the module name by default, i.e. comRetargeting."    ;
        return 0;
    }
