...
#ifndef LIPVEL_THREAD
#define LIPVEL_THREAD
...
class LIPvelThread: public yarp::os::RateThread
{
    ...
    // ZMP 
    Eigen::Vector2d zmpVel;
    Eigen::Vector2d zmp;
    Eigen::Vector2d zmp_old;
