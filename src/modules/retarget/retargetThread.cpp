...
{  
    ...
    jointRead.open(string("/xsensToRobot/q:i").c_str());
    posRead.open(string("/xsensToRobot/pose:i").c_str()); 
...
bool retargetThread::initJoint()
{
    ...
    port_joint.open(string("/xsensToRobot/q:o").c_str()); 
    
    return true;  
}


bool retargetThread::initOdometry()
{
