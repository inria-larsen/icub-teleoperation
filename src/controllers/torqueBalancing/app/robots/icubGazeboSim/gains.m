...
references.smoothingTimeMinJerkComDesQDes    = 10;
...
gain.impedances           = [impTorso(1,:),impHead(1,:),impArms(1,:),impArms(1,:),impLeftLeg(1,:),impRightLeg(1,:)];
gain.increasingRatesImp   = [impTorso(2,:),impHead(2,:),impArms(2,:),impArms(2,:),impLeftLeg(2,:),impRightLeg(2,:)];
